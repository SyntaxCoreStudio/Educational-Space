...
const worlds = {
  Mercury: {
    ratio: 0.38,
    icon: "☿️",
    img: "/static/assets/planets/mercury.jpg",
  ...
  Venus: {
    ratio: 0.91,
    icon: "🟠",
    img: "/static/assets/planets/venus.jpg",
  ...
  Earth: {
    ratio: 1,
    icon: "🌍",
    img: "/static/assets/planets/earth.jpg",
    desc: "Our home world",
  ...
  Moon: {
    ratio: 0.165,
    icon: "🌕",
    img: "/static/assets/planets/moon.jpg",
  ...
  Mars: {
    ratio: 0.38,
    icon: "🔴",
    img: "/static/assets/planets/mars.jpg",
  ...
  Jupiter: {
    ratio: 2.34,
    icon: "🟤",
    img: "/static/assets/planets/jupiter.jpg",
  ...
  Saturn: {
    ratio: 1.08,
    icon: "🪐",
    img: "/static/assets/planets/saturn.jpg",
  ...
  Uranus: {
    ratio: 0.89,
    icon: "⛢",
    img: "/static/assets/planets/uranus.jpg",
  ...
  Neptune: {
    ratio: 1.14,
    icon: "♆",
    img: "/static/assets/planets/neptune.jpg",
